...
func TestDataNext(t *testing.T) {
	var testCases = []struct {
		...
		{"testing multiple data events",
			&Data{
				stream: []DataFrame{
					&Bar{Mark: Mark{symbol: "TEST.DE"}, Close: 110},
					&Bar{Mark: Mark{symbol: "TEST.DE"}, Close: 100},
					&Bar{Mark: Mark{symbol: "TEST.DE"}, Close: 90},
				},
			},
			&Data{
				latest: map[string]DataFrame{
					"TEST.DE": &Bar{Mark: Mark{symbol: "TEST.DE"}, Close: 110},
				},
				list: map[string][]DataFrame{
					"TEST.DE": {
						&Bar{Mark: Mark{symbol: "TEST.DE"}, Close: 110},
		...
		{"testing single data events",
			...
			&Data{
				latest: map[string]DataFrame{
					"TEST.DE": &Bar{Mark: Mark{symbol: "TEST.DE"}, Close: 100},
				},
				list: map[string][]DataFrame{
					"TEST.DE": {
						&Bar{Mark: Mark{symbol: "TEST.DE"}, Close: 100},
...
func TestUpdateLatest(t *testing.T) {
	var testCases = []struct {
		...
		{"test update filled latest",
			Data{
				latest: map[string]DataFrame{
					"TEST.DE": &Bar{Mark: Mark{symbol: "TEST.DE"}, Close: 80},
				},
			},
			&Bar{Mark: Mark{symbol: "TEST.DE"}, Close: 100},
			Data{
		...
		{"test update filled latest with other symbol data",
			...
			&Bar{Mark: Mark{symbol: "BAS.DE"}, Close: 90},
			Data{
				latest: map[string]DataFrame{
					"TEST.DE": &Bar{Mark: Mark{symbol: "TEST.DE"}, Close: 100},
					"BAS.DE":  &Bar{Mark: Mark{symbol: "BAS.DE"}, Close: 90},
				},
			},
		},
	}
